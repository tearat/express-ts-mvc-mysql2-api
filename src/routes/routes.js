...
router.post('/api/books', async (req, res) => booksController.create(req, res, req.body, req.files[0]))
router.put('/api/books/:id', async (req, res) => booksController.update(req, res, req.body, req.files[0]))
